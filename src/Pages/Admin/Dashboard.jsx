...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Don't call API until authentication is ready
...
function Products() {
  return (
    <div className="bg-gray-900 p-6 rounded border border-gray-800 text-white max-w-2xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-800 border border-gray-700 p-3 rounded text-white outline-none"
          />
        </div>
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="Topwear / Bottomwear / Footwear"
            className="w-full bg-gray-800 border border-gray-700 p-3 rounded text-white outline-none"
          />
        </div>
        ...
        <button
          type="button"
          className="bg-indigo-600 hover:bg-indigo-700 py-3 rounded font-semibold mt-2"
        >
          Add Product
        </button>
