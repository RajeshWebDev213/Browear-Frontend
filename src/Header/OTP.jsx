...
function OTP() {
  ...
  const verifyOTP = async (e) => {
    ...
    const res = await fetch("https://browear-backend-production.up.railway.app/api/auth/verify-otp", {
      method: "POST",
      headers: {
  ...
  await fetch("https://browear-backend-production.up.railway.app/api/auth/resend-otp", {
  method: "POST",
  headers: {
    "Content-Type": "application/json"
  },
